    ...
    <section>
      <div class="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div class="bg-darkblue p-8 md:p-12 lg:px-16 lg:py-24">
            <div class="mx-auto max-w-xl text-center">
              <h2 class="text-2xl font-bold text-white md:text-3xl">
                Our membership program
              </h2>

              <p class="hidden text-white/90 sm:mt-4 sm:block">{blurb}</p>

              <div class="mt-4 md:mt-8">
                <a
                  href="/csa"
                  class="inline-block rounded border border-white bg-white px-12 py-3 text-sm font-medium text-blue-500 transition hover:bg-transparent hover:text-white focus:outline-none focus:ring focus:ring-babyblue"
                >
                  Get Started Today
                </a>
              </div>
