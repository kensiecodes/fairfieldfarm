    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-20 mx-auto flex flex-col">
        <div class="lg:w-4/6 mx-auto">
          ...
          <div class="flex flex-col sm:flex-row mt-10">
            <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
              <div class="w-40 h-40 rounded-full inline-flex items-center justify-center text-gray-400">
                <img
                  src="seraphine.jpg"
                  class="h-full w-auto overflow-hidden object-cover"
                ></img>
              </div>
            ...
            <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
              <p class="leading-relaxed text-lg mb-4">
                ...
                and healthful food. Seraphine offers 1-on-1s, free kids classes
                every first saturday of each month of the growing season, and of
                course, tons and tons of veggies at the stand. In her off-time,
                she is cooking, reading, or bicycling.
              </p>
          ...
          <div class="flex flex-col sm:flex-row mt-10">
            <div class="sm:w-2/3 sm:pr-8 sm:py-8 sm:border-r border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
              <p class="leading-relaxed text-lg mb-4">
          ...
          <div class="flex flex-col sm:flex-row mt-10">
            ...
            <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
              <p class="leading-relaxed text-lg mb-4">
                ...
                offers classes and 1-on-1 trainings on vegetable genetics and
                breeding.
              </p>
              <a class="text-indigo-500 inline-flex items-center">
                Twitter
